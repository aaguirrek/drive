<template>
  ...
  <div
   ...
   <!--   <video-player
      class="video-js vjs-fluid max-h-[85vh]"
      type="video/mp4"
     v-if="
      isVideo &&
  ...
  <div  v-if="allow_download" class=" text-center w-full">
    <Button 
      v-if="allow_download" variant="solid" @click="setDownload()" class="ml-auto px-8">
            Descargar
    </Button>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      textFileContent: "",
      allow_download: this.previewEntity.allow_download,
