        ...
        <div class="w-full p-4 border-b overflow-visible">
          <div class="flex items-center">
            <div class="font-medium truncate text-xl">
              {{ $store.state.entityInfo.length }} Elementos seleccionados
            </div>
          </div>
        </div>
      </div>
      <div v-else-if="entity">
        ...
        <div v-if="tab === 0" class="h-full border-b pb-12">
          ...
          <div class="p-4 space-y-7">
            <div v-if="entity.owner === 'me'">
              <div class="text-lg font-medium mb-4">Administrar Acceso</div>
            ...
            <div class="text-lg font-medium">Propiedades</div>
        ...
        <div v-if="tab === 1" class="h-full pb-12">
          <div v-if="tab === 1" class="pl-4 pt-4 sticky top-0 bg-white">
            <div class="flex items-center">
              <span class="font-medium text-lg">Commentarios</span>
            </div>
          </div>
          <div
            ...
            <div v-if="userId != 'Guest'" class="flex items-center gap-3 my-4">
              ...
              <Button @click="postComment" variant="solid">Agregar</Button>
            </div>
          </div>
