<template>
  <Dialog
    v-model="open"
    :options="{
      title: `Compartir '${$resources.entity.data?.title}'`,
      size: 'lg',
    }">
    <template #body-content>
          ...
          <Popover transition="default">
            <template #target="{ togglePopover }">
              <Button appearance="minimal" @click="togglePopover()">
                ...
                {{ generalAccess.read ? "Acceso Público" : "Acceso Restringido" }}
              </Button>
            </template>
            ...
            <Popover transition="default">
              <template #target="{ togglePopover }">
                <Button appearance="minimal" @click="togglePopover()">
                  ...
                  {{ generalAccess.write ? "Puede Editar" : "Puede Ver" }}
                </Button>
              </template>
              <template #body-main="{ togglePopover }">
                <div class="flex flex-col p-1">
      ...
      <div class="flex mt-5 text-base text-gray-600">Usuarios con acceso</div>
      ...
      <div
        ...
        class="flex flex-col">
        <div class="flex mt-5 text-base text-gray-600">Grupos con acceso</div>
        <div
  ...
  computed: {
    accessMessage() {
      if (this.generalAccess.read) {
        ...
        return "Solo los usuarios con acceso pueden ver el archivo";
      }
    },
    accessChanged() {
      return (
    ...
    toggleComments() {
      toast({
        title: this.allowComments
          ...
          : "Se han activado los comentarios",
    ...
    toggleDownload() {
      toast({
        title: this.allowDownload
          ? "Se restringió la descarga"
          : "Se habilitó la descarga",
        text: this.allowDownload
          ? "Los usuarios no pueden descargar"
