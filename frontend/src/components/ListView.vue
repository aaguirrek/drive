      ...
      <table class="max-h-full min-w-full">
        <thead
          ...
          <tr class="text-left text-base text-gray-600">
            <th class="hidden px-2.5 py-3 font-normal md:table-cell">Nombre</th>
            <th class="hidden px-2.5 py-3 font-normal lg:table-cell">Propietario</th>
            <th class="hidden px-2.5 py-3 font-normal md:table-cell">
              Modificado
            </th>
            <th class="hidden px-2.5 py-3 font-normal lg:table-cell">Tamaño</th>
          </tr>
        </thead>
        <tbody>
          <tr
